...
public final class AppDao_Impl implements AppDao {
      ...
      public CardWithTracks call() throws Exception {
        ...
        try {
          ...
          try {
            ...
            __fetchRelationshiptracksAscomParrisYotoliteDataTrackEntity(_collectionTracks);
  ...
  private void __fetchRelationshiptracksAscomParrisYotoliteDataTrackEntity(
    ...
    if(_map.size() > RoomDatabase.MAX_BIND_PARAMETER_CNT) {
      ...
      while(_mapIndex < _limit) {
        ...
        if(_tmpIndex == RoomDatabase.MAX_BIND_PARAMETER_CNT) {
          __fetchRelationshiptracksAscomParrisYotoliteDataTrackEntity(_tmpInnerMap);
