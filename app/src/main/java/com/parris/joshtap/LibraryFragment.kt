...
import com.parris.joshtap.ui.TrackAdapter
...
class LibraryFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val adapter = TrackAdapter(onItemClick = { track ->
            ...
            com.parris.joshtap.ui.TrackActionBottomSheet.show(requireContext(), parentFragmentManager, track.displayName, track.localUri, track.id) { cardId ->
